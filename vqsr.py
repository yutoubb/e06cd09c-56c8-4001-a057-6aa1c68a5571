...
class GATK_VQSR(define.Wrapper):
    class Inputs(define.Inputs):
        ...
        In_vcf_tbi = define.input("Input tbi file", description= "Index file for In_vcf",required=False,list=False)
        Reference =define.input(name = "Reference file", description = "Reference sequence in FASTA format.",required = False, list=False)
        In_resource_hapmap = define.input(name = "In_resource_hapmap",description = "Hapmap sites for which to apply a prior probability of being correct but which aren't used by the algorithm (training and truth sets are required to run).",required = False,list = False)
        In_resource_omni = define.input(name = "In_resource_ommi",description = "Omni sites for which to apply a prior probability of being correct but which aren't used by the algorithm (training and truth sets are required to run).",required = False,list = False)
        In_resource_1000G = define.input(name = "In_resource_1000G",description = "1000G sites for which to apply a prior probability of being correct but which aren't used by the algorithm (training and truth sets are required to run).",required = False,list = False)
        In_resource_dbsnp = define.input(name = "In_resource_dbsnp",description = "Dbsnp sites for which to apply a prior probability of being correct but which aren't used by the algorithm (training and truth sets are required to run).",required = False,list = False)  
        In_resource_mills = define.input(name = "In_resource_mills",description = "mills sites for which to apply a prior probability of being correct but which aren't used by the algorithm (training and truth sets are required to run).",required = False,list = False)
    ...
    class Outputs(define.Outputs):
        ...
        Out_vcf = define.output(name="Filtered snp vcf file",description="Filtered snp vcf file.",required=False,list=False)
	...
	SelectType= define.enum([(u'SNP',u'SNP',u'SNP'),(u'INDEL',u'INDEL',u'INDEL'),(u'MIXED',u'MIXED',u'MIXED'),(u'MNP',u'MNP',u'MNP'),(u'SYMBOLIC',u'SYMBOLIC',u'SYMBOLIC'),(u'NO_VARIATION',u'NO_VARIATION',u'NO_VARIATION')],name = "SelectType", description = "Select only a certain type of variants from the input file.Valid types are INDEL,SNP,MIXED,MNP,SYMBOLIC,NO_VARIATION.",required = True,default = 'SNP')
        ...
        Resource_mills = define.string(name="Resource_mills",description = "Mills sites for which to apply a prior probability of being correct but which aren't used by the algorithm (training and truth sets are required to run).",required = False,default ='mills,known=true,training=true,truth=true,prior=12.0') 
